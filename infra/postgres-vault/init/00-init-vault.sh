...
GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA vault TO :"vault_app_user";
...
ALTER DEFAULT PRIVILEGES IN SCHEMA vault GRANT SELECT, INSERT, UPDATE ON TABLES TO :"vault_app_user";
